// 목록 클릭 시
// actionForm action ="/list.do" 수정후 submit

const actionForm = document.querySelector("#actionForm");

// read.jsp 수정 목록 버튼 이벤트
// read.jsp에서 수정 클릭시
// actionForm action ="/modify.do" 수정후 submit
...
// 답변 클릭 시 actionForm action ="/replyView.do" 수정후 submit
...
// modify.jsp에서 수정 삭제 클릭시, 목록 버튼 이벤트
