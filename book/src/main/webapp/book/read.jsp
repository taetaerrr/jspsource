...
<form>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="title" name="title" value="<%=dto.getTiitle()%>" readonly>
    </div>
  </div>  
  <div class="row mb-3">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
	<textarea name="description" id="description" cols="3" class="form-control">value=<%=dto.getDesciption() %></textarea>
    </div>
  </div>  
